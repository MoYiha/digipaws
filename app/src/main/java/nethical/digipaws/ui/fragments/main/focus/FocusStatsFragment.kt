...
import nethical.digipaws.data.db.FocusStatsEntity
...
class FocusStatsFragment : Fragment() {
    ...
    private fun updateWeeklyGraph(sessions: List<FocusStatsEntity>) {
        val days = mutableListOf<nethical.digipaws.ui.views.WeeklyBarGraphView.DayData>()
        ...
        for (i in 6 downTo 0) {
            ...
            days.add(nethical.digipaws.ui.views.WeeklyBarGraphView.DayData(
